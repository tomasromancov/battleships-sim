...
public class ClockwiseTargeting extends TargetingApproach{
	...
	public ClockwiseTargeting(int columns, int rows) {
		super(columns, rows);
	}
	...
	public String play(char[][] grid, String lastLocation) {
		...
		if(orientation == '0') {
			...
			System.out.println("Error: no valid squares around " + searchedLocations.get(0) + " were found");
		}
		...
		switch(direction) {
			...
			case 'l':
				...
				break;
			default:
				System.out.println("Error: unexpected direction registered in targeting approach.");
		}
